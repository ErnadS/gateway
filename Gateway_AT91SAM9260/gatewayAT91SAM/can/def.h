...
/** definitions used for object dictionary access. ie SDO Abort codes . (See NCABbus specification)
 */
...
/*  NCABbus Function Codes 
   ---------------
  compatible with canopen DS301 
*/
#define NMT	   0x0
#define SYNC       0x1
...
/* NciMT Command Spefier, sent by master to change a slave state */
/* ------------------------------------------------------------- */
