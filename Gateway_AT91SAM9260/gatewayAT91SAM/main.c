	...
	*tempChar = 0;
	...
	while (1) {
		...
		if (nGpio == 0) {
			...
			if (nButtonCounter >= 3) {
				///////////////////////////////////////////////////////////////////////
				printf("!!! Remove dataloger\n");
				///////////////////////////////////////////////////////////////////////
				remove(DATA_LOGER_CONFIG_PATH);
				dataLogerSaver_init();

				///////////////////////////////////////////////////////////////////////
				printf("!!! Removing password file\n");
				///////////////////////////////////////////////////////////////////////
				...
				///////////////////////////////////////////////////////////////////////
				removedirectoryrecursively("/srv/www/logFiles/");

				///////////////////////////////////////////////////////////////////////
				printf("!!! Clean DHCP file\n");
				///////////////////////////////////////////////////////////////////////
				GW_DHCP pdhcpStruct;
				...
				///////////////////////////////////////////////////////////////////////
				printf("!!! Delete all alarm messages\n");
				///////////////////////////////////////////////////////////////////////
				gwAlarmLogUtility_deleteAllAlarmMsgs();

				///////////////////////////////////////////////////////////////////////
				printf("!!! Make default e-mail config\n");
				///////////////////////////////////////////////////////////////////////
				emailConfig_init();
